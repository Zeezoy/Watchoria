<div>
    ...
    <input type="text" name="title" value="{{ old('title', isset($movie) ? $movie->title : '') }}"
           style="width:100%;background:rgba(240,255,255,0.07);border:0.5px solid rgba(135,206,235,0.25);border-radius:8px;padding:10px 12px;font-size:13px;color:#F0FFFF;outline:none"
...
<div>
    ...
    <select name="status"
            style="width:100%;background:rgba(10,0,50,0.8);border:0.5px solid rgba(135,206,235,0.25);border-radius:8px;padding:10px 12px;font-size:13px;color:#F0FFFF;outline:none">
...
<div>
    ...
    <textarea name="description" rows="4"
              style="width:100%;background:rgba(240,255,255,0.07);border:0.5px solid rgba(135,206,235,0.25);border-radius:8px;padding:10px 12px;font-size:13px;color:#F0FFFF;outline:none;resize:vertical"
              onfocus="this.style.borderColor='rgba(135,206,235,0.6)'"
